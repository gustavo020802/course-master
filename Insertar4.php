...
mysqli_query($conexion,"insert into opl(nombre,ejemplo)values('$_REQUEST[nombre]','$_REQUEST[ejemplo]')")or die("Problema en el Select".mysqli_error());
mysqli_close($conexion);
echo"La Formula ha sido dada de alta";
?>
         </p>
       <p><a href="insertar.php">¡Regresar!</a></p>
</center></font>
</body>
</html>